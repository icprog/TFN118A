...
#define RESEVER_BASE nrf_page_size * (nrf_page_num -2)//保留区基地址
...
#define TAG_ID_IDX											2//标签ID 2~5
#define TAG_STATE_IDX 									6//状态字
...
#define TAG_VERSION_IDX									7//版本索引号
#define TAG_STYPE_IDX										8//信息标签类型
#define TAG_SDATA_IDX										9//传感数据
...
#define CMD_FIX_LENGTH TID_LENGTH+RID_LENGTH+CMD_LENGTH//
//命令索引号
#define CMD_IDX	10
//文件操作索引号
...
typedef enum 
{
	...
	FILE_BODER_ERR=0X01,//超出边界，长度/偏移量超出
}ERROR_L_Typedef;
