...
函数用法：
    ...
    ASCII_GetData(0x41,ASCII_5X7,DZ_Data);      //读取5X7点阵 ASCII 编码A的点阵数据，并将点阵数据存在DZ_Data数组中；数据长度为8 BYTE
	  ...
	  ASCII_GetData(0x41,ASCII_24_B,DZ_Data);     //读取24X24点阵不等宽 ASCII 编码A的点阵数据，并将点阵数据存在DZ_Data数组中；数据长度为74 BYTE
	  ASCII_GetData(0x41,ASCII_16X32,DZ_Data);    //读取16X32点阵 ASCII 编码A的点阵数据，并将点阵数据存在DZ_Data数组中；数据长度为64 BYTE
	  ASCII_GetData(0x41,ASCII_32_B,DZ_Data);     //读取32X32点阵不等宽 ASCII 编码A的点阵数据，并将点阵数据存在DZ_Data数组中；数据长度为130 BYTE
*************************************************************/
